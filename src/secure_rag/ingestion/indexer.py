...
from ..domain.models import DocumentRecord, IndexProgress, IndexReport
from ..retrieval.embeddings import Embedder
from ..retrieval.vector_store import QdrantStore, QdrantTransientWriteError
from .cache import ExtractedTextCache, is_cacheable_extension
...
class Indexer:
    ...
    def run(
        ...
        *,
        ...
        lock_path = self.config.locks_path / "index-build.lock"
    ...
    def _write_safe_report(self, report: IndexReport) -> None:
        path = self.config.reports_path / f"index-{report.build_id}.json"
