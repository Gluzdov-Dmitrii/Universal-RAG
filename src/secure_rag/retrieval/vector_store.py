...
from ..security.policy import RetrievalPolicy
...
class QdrantStore:
    ...
    def search(
        ...
        policy = RetrievalPolicy(access_group=access_group)
        query_filter = models.Filter(
            must=[
                models.FieldCondition(
                    key="access_group",
                    match=models.MatchValue(value=policy.access_group),
                ),
                models.FieldCondition(key="goz", match=models.MatchValue(value=policy.goz)),
                models.FieldCondition(
                    key="is_final",
                    match=models.MatchValue(value=policy.is_final),
                ),
                models.FieldCondition(
