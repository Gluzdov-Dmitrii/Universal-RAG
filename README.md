...
поиск в Qdrant, количество найденных фрагментов, sanitization, вызов модели, восстановление
ответа и сохранение состояния. Это операционные статусы, а не скрытые рассуждения модели.
